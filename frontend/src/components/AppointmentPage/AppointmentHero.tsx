...
export default function AppointmentHero() {
    ...
    return (
        <section ref={sectionRef} className="bg-[#EADDD7] h-[400px] text-center relative overflow-hidden flex flex-col pt-12">
            ...
            <div className="max-w-4xl mx-auto hero-content relative z-10 flex flex-col pt-4">
