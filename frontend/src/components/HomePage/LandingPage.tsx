...
const LandingPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* z-[3]: Text Content Grid Wrapper */}
      <div className="absolute inset-0 z-[3] w-full max-w-[1400px] mx-auto pointer-events-none">
        <h1
        ...
        <div className="textContent absolute top-[26%] sm:top-[28%] lg:top-[75%] left-6 lg:left-12 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 pointer-events-auto">
